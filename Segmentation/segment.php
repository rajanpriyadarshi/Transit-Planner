...
<body onload="initialize()">
    ...
    <div id="nav" >
    <h3 style="text-decoration:underline;">Enter A File To Plot:</h3>
...
<div id="map_canvas" style="width: 80%; height:800px; float:right; border: 0px solid #dddddd; color: black;"></div>
...
function upload() {
      ...
      r.onload = function(e) { 
	    ...
	    alert("Put the numbers in ascending order and keep in mind if up trails then 1 should be on below level and vice versa");
