    ...
    <?php
            if (isset($_FILES['my_file'])) {
                ...
                for ($i = 0; $i < $fileCount; $i++) {
                        ...
                        $dir = 'input/';
                        $uploadfile = $dir.basename($_FILES['my_file']['name'][$i]);
                        move_uploaded_file($_FILES['my_file']['tmp_name'][$i],$uploadfile);
...
?>
<?php 
echo exec('python seg_folder_file.py');
?>
